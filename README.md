...
### 💰 [Mailtrap](https://mailtrap.io/) - Mailtrap Email Delivery Platform is an end-to-end sending for devs to test, send and control emails in one place. Get **70% OFF on all Email API/SMTP pricing plans with code MAILTRAP2022**
